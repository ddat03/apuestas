# ============================================================
#  app_pages/pagina_partido.py — Pestaña "Analizar Partido"
#
#  Creado por Diego Aleman.
#
#  (Antes era dashboard_partido.py suelto. Ahora el dashboard es
#  multipágina: dashboard_partido.py es el entry point con
#  st.navigation, y esta es una de sus páginas.)
#
